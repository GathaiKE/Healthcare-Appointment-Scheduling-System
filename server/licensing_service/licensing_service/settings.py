"""
Django settings for licensing_service project.
...
ROOT_URLCONF = 'licensing_service.urls'
...
WSGI_APPLICATION = 'licensing_service.wsgi.application'
...
PUBLIC_KEYS={
    'doctor_service':SIMPLE_JWT['VERIFYING_KEY']
}
